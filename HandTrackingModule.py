...
class HandDetector:
    ...
    def __init__(self, mode=False, maxHands=2, detectionCon=0.5, minTrackCon=0.5):
        ...
        self.hands = self.mpHands.Hands(static_image_mode =mode , max_num_hands=self.maxHands,min_detection_confidence=self.detectionCon,min_tracking_confidence=self.minTrackCon)
